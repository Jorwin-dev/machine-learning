...
'''
df.drop(columns=['storage/path', 'storage/name', 'storage/read_only'])
df.drop(columns=['transfer/id', 'transfer/time_transferring', 'transfer/progress', 'transfer/transferred'])
df.drop(columns=['printer/axis_x', 'printer/axis_y'])
df.drop(columns=['printer/flow', 'printer/speed'])
'''